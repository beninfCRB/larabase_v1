    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="{{ asset('image/majalengka.png') }}" alt="" width="150" height="auto">
            </div>
            <div class="mx-auto text-center">
                <h1>KABUPATEN MAJALENGKA</h1>
            </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                ...
                                Dinas Perindustrian Dan Perdagangan merupakan perangkat daerah di Provinsi Jawa Barat
                                yang mengurusi urusan pemerintah bidang perindustrian dan perdagangan.
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    {{ env('APP_NAME') }} Versi {{ env('APP_VERSION') }}
                </div>
            </div>
        </div>
    </div>
